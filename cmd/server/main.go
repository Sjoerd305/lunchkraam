		...
		r.Group(func(r chi.Router) {
			...
			r.Route("/api", func(r chi.Router) {
				...
				r.Group(func(r chi.Router) {
					...
					r.Get("/operator/finance-control", h.APIAdminFinanceControl)
					...
					r.With(httprate.Limit(10, time.Minute, httprate.WithKeyFuncs(apimw.KeyByUserID))).Post("/operator/shop-expenses/revolut-import/preview", h.APIShopExpensesRevolutPreview)
					...
					r.Get("/operator/shop-expenses/pending-reviews", h.APIPendingImportReviews)
					r.With(httprate.Limit(30, time.Minute, httprate.WithKeyFuncs(apimw.KeyByUserID))).Post("/operator/shop-expenses/pending-reviews/{id}/merge", h.APIPendingReviewMerge)
					r.With(httprate.Limit(30, time.Minute, httprate.WithKeyFuncs(apimw.KeyByUserID))).Post("/operator/shop-expenses/pending-reviews/{id}/dismiss", h.APIPendingReviewDismiss)
				...
				r.Group(func(r chi.Router) {
					...
					r.Get("/admin/finance-control", h.APIAdminFinanceControl)
					r.Get("/admin/finance-corrections", h.APIAdminFinanceCorrectionsList)
					r.With(httprate.Limit(30, time.Minute, httprate.WithKeyFuncs(apimw.KeyByUserID))).Post("/admin/finance-corrections", h.APIAdminFinanceCorrectionCreate)
					r.With(httprate.Limit(30, time.Minute, httprate.WithKeyFuncs(apimw.KeyByUserID))).Delete("/admin/finance-corrections/{id}", h.APIAdminFinanceCorrectionDelete)
					...
					r.With(httprate.Limit(10, time.Minute, httprate.WithKeyFuncs(apimw.KeyByUserID))).Post("/admin/shop-expenses/revolut-import/preview", h.APIShopExpensesRevolutPreview)
					...
					r.Get("/admin/shop-expenses/pending-reviews", h.APIPendingImportReviews)
					r.Post("/admin/shop-expenses/pending-reviews/{id}/merge", h.APIPendingReviewMerge)
					r.Post("/admin/shop-expenses/pending-reviews/{id}/dismiss", h.APIPendingReviewDismiss)
