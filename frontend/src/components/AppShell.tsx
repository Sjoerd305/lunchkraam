    ...
    <div className="min-h-screen bg-linear-to-b from-brand-50 via-white to-slate-50 text-slate-800">
      <header className="sticky top-0 z-20 border-b border-slate-200/80 bg-white/90 backdrop-blur-md">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-3 px-4 py-2 sm:px-5">
          ...
          <details ref={menuDetailsRef} className="relative">
            <summary className="btn-secondary cursor-pointer list-none rounded-lg px-3 py-1.5 text-sm font-medium [&::-webkit-details-marker]:hidden">
              Menu
            </summary>
